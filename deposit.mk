...
PROTOBUF_CURRENT_MAJOR = 23
PROTOBUF_CURRENT_MINOR = 2
ZEROMQ_CURRENT = 5
...
$(eval $(call external_library_source,https://github.com/google/protobuf/releases/download/v$(PROTOBUF_VERSION),protobuf-cpp-$(PROTOBUF_VERSION).tar.gz,f2f180e9343cbb2b9a8482255bfec2176a2cc7fa22de496535a0a0cf38797495))
