...
\item Adaptive stepsize Runge-Kutta method, based on the ARKode solver of SUNDIALS \cite{hindmarsh2005sundials}
\end{itemize}
...
example model ``HodgkinHuxley\_1952\_neuron\_model.phml'', which is distributed
