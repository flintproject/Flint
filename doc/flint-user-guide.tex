...
Then the model window will appear as in Fig.~\ref{fig:org6401198}.
...
\caption{\label{fig:org6401198}The model window.}
\end{figure}
...
panel in the right side like Fig.~\ref{fig:orge9644d2}, and both the cross mark
(as ``Cancel'') and ``Detail'' buttons will be enabled.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{image/hh-progress.png}
\caption{\label{fig:orge9644d2}The progress bar for the model.}
\end{figure}

Wait until the status bar tells that the simulation completed (see
Fig.~\ref{fig:orgecbe80d}).

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{image/hh-completed.png}
\caption{\label{fig:orgecbe80d}The status bar indicates the simulation completed.}
\end{figure}
...
Then a detail window will appear as in Fig.~\ref{fig:orga0d291c}.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{image/hh-detail.png}
\caption{\label{fig:orga0d291c}The detail window.}
\end{figure}
...
in the main window until closed, like Fig.~\ref{fig:org7d9154f}.

\section{Configuring simulation tasks}
\label{sec:org2c234f3}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{image/lr.png}
\caption{\label{fig:org7d9154f}The model window.}
\end{figure}
...
The ``Output Variables'' panel (Fig.~\ref{fig:orgd8c4225}) allows
...
and are summarized in Table~\ref{tab:org4ffb8bb}. With the ``Filter Column''
...
\caption{\label{fig:orgd8c4225}The ``Output Variables'' panel.}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org4ffb8bb}Output variable's properties to be matched}
\centering
\begin{tabular}{ll}
...
\caption{\label{fig:org2647259}``zip'' and ``product'' in the ``Edit parameter set'' window.}
\end{figure}

\section{Starting simulation}
\label{sec:org6ba0f16}
...
one for a single job on the detail windows like Fig.~\ref{fig:org439dad8}.
...
\caption{\label{fig:org439dad8}The detail window during simulation.}
\end{figure}

\section{Controlling simulation jobs}
\label{sec:orgf52912d}
After starting simulation jobs, users can control them instead of just waiting
for them finishing.

\subsection{Cancel jobs}
\label{sec:org36b9fd8}
There is another way to cancel running jobs; pushing the cross mark on the
control panel (see Fig.~\ref{fig:org43d52f5}), which cancels a job i.e. all
of its tasks together.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{image/lr-progress.png}
\caption{\label{fig:org43d52f5}The progress bar / cross mark / ``Detail'' button on the control panel.}
\end{figure}

\subsection{Pause and resume jobs}
\label{sec:orgc9353c1}
As in Fig.~\ref{fig:org8747660}, users can pause jobs at any time during simulation
...
\caption{\label{fig:org8747660}The Control Menu.}
\end{figure}
