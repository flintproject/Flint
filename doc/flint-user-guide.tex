...
Then the model window will appear as in Fig.~\ref{fig:orge9a0f7f}.
...
\caption{\label{fig:orge9a0f7f}The model window.}
\end{figure}
...
panel in the right side like Fig.~\ref{fig:orgd18e7ce}, and both the cross mark
(as ``Cancel'') and ``Detail'' buttons will be enabled.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{image/hh-progress.png}
\caption{\label{fig:orgd18e7ce}The progress bar for the model.}
\end{figure}

Wait until the status bar tells that the simulation completed (see
Fig.~\ref{fig:org00fefb1}).

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{image/hh-completed.png}
\caption{\label{fig:org00fefb1}The status bar indicates the simulation completed.}
\end{figure}
...
Then a detail window will appear as in Fig.~\ref{fig:orga47d082}.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{image/hh-detail.png}
\caption{\label{fig:orga47d082}The detail window.}
\end{figure}
...
in the main window until closed, like Fig.~\ref{fig:orgb0aef67}.

\section{Configuring simulation tasks}
\label{sec:org716c728}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{image/lr.png}
\caption{\label{fig:orgb0aef67}The model window.}
\end{figure}
...
The ``Output Variables'' panel (Fig.~\ref{fig:orgb2edd15}) allows
...
and are summarized in Table~\ref{tab:org579ff41}. With the ``Filter Column''
...
\caption{\label{fig:orgb2edd15}The ``Output Variables'' panel.}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org579ff41}Output variable's properties to be matched}
\centering
\begin{tabular}{ll}
...
\caption{\label{fig:orgdb4d64f}``zip'' and ``product'' in the ``Edit parameter set'' window.}
\end{figure}

\section{Starting simulation}
\label{sec:org4128ab8}
...
one for a single job on the detail windows like Fig.~\ref{fig:org40fb1de}.
...
\caption{\label{fig:org40fb1de}The detail window during simulation.}
\end{figure}

\section{Controlling simulation jobs}
\label{sec:orgb48195e}
After starting simulation jobs, users can control them instead of just waiting
for them finishing.

\subsection{Cancel jobs}
\label{sec:org19b48a1}
There is another way to cancel running jobs; pushing the cross mark on the
control panel (see Fig.~\ref{fig:org74bdd2b}), which cancels a job i.e. all
of its tasks together.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{image/lr-progress.png}
\caption{\label{fig:org74bdd2b}The progress bar / cross mark / ``Detail'' button on the control panel.}
\end{figure}

\subsection{Pause and resume jobs}
\label{sec:org0fcfae7}
As in Fig.~\ref{fig:org074d009}, users can pause jobs at any time during simulation
...
\caption{\label{fig:org074d009}The Control Menu.}
\end{figure}
