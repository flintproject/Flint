...
#ifndef FLINT_METHOD_ASSIGNMENT_GRAMMAR_H_
#define FLINT_METHOD_ASSIGNMENT_GRAMMAR_H_
...
struct AssignmentGrammar : qi::grammar<TIterator, Compound()> {

	template<typename TTokenDef>
	AssignmentGrammar(TTokenDef const &td)
		: AssignmentGrammar::base_type(statement)
	{
