...
BOOST_AUTO_TEST_CASE(literal)
{
	...
	BOOST_CHECK_EQUAL(r[2], "00000000-0000-0000-0000-000000000000 %x#6 0.0012");
	BOOST_CHECK_EQUAL(r[3], "00000000-0000-0000-0000-000000000000 %x#0 0.0012");
	BOOST_CHECK_EQUAL(r[4], "00000000-0000-0000-0000-000000000000 %y#2 4.5e-05");
	BOOST_CHECK_EQUAL(r[5], "00000000-0000-0000-0000-000000000000 %y#4 4.5e-05");
	BOOST_CHECK_EQUAL(r[6], "00000000-0000-0000-0000-000000000000 %y#6 4.5e-05");
	BOOST_CHECK_EQUAL(r[7], "00000000-0000-0000-0000-000000000000 %y#0 4.5e-05");
	BOOST_CHECK_EQUAL(r[8], "00000000-0000-0000-0000-000000000000 %z#2 (times -2.3e+30 5e-11)");
	BOOST_CHECK_EQUAL(r[9], "00000000-0000-0000-0000-000000000000 %z#4 (times -2.3e+30 5e-11)");
	BOOST_CHECK_EQUAL(r[10], "00000000-0000-0000-0000-000000000000 %z#6 (times -2.3e+30 5e-11)");
	BOOST_CHECK_EQUAL(r[11], "00000000-0000-0000-0000-000000000000 %z#0 (times -2.3e+30 5e-11)");
}
