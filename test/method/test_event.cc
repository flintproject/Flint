...
BOOST_AUTO_TEST_CASE(function)
{
	...
	BOOST_CHECK_EQUAL(r[5], "00000000-0000-0000-0000-000000000000 %v#0 ($lookback %x (minus %time 0.001))");
	BOOST_CHECK_EQUAL(r[6], "00000000-0000-0000-0000-000000000000 %w#0 ($lookback %x (minus %time @dt))");
