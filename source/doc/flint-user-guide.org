...
*** On Windows
Please download the installer package =Flint-2.5.0-windows.x86_64.msi= at
...
*** On macOS
Please download the installer package =Flint-2.5.0-mac.dmg= at
[[https://sourceforge.net/projects/flintproject/files/Flint/]].
...
*** On CentOS/RHEL
Please download =Flint-2.5.0-el7.x86_64.zip= or =Flint-2.5.0-el8.x86_64.zip=
...
[[https://github.com/flintproject/Flint/archive/Flint-2.5.0.tar.gz]],
...
[[https://github.com/flintproject/Flint/tree/Flint-2.5.0/example/HodgkinHuxley_1952_neuron_model.phml]].
