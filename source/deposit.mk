...
$(eval $(call external_library_source,https://archives.boost.io/release/$(BOOST_VERSION)/source,$(BOOST_UNDERSCORE).tar.bz2,fc9f85fc030e233142908241af7a846e60630aa7388de9a5fafb1f3a26840854))
...
$(eval $(call external_library_source,https://download.gnome.org/sources/libxml2/$(LIBXML2_MAJOR_MINOR_VERSION),libxml2-$(LIBXML2_VERSION).tar.xz,5d2cc3d78bec3dbe212a9d7fa629ada25a7da928af432c93060ff5c17ee28a9c))
